...
await page.goto("http://localhost:3000/apple-watch-ultra-4", { waitUntil: "networkidle", timeout: 60000 });
...
await page.screenshot({ path: "scripts/shot_ultra4_top.png" });
await page.evaluate(() => window.scrollTo(0, document.body.scrollHeight / 2));
await page.waitForTimeout(500);
await page.screenshot({ path: "scripts/shot_ultra4_mid.png" });
await browser.close();