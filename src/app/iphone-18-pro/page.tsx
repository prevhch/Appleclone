...
const P = (stem: string, ext: "jpg" | "png" = "jpg") => `/apple/v/iphone-18-pro/a/images/overview/${stem}`;
const V = (anim: string) =>
  `/apple/105/media/us/iphone-18-pro/2026/591df885-5ee2-4173-86e6-401021249f7c/anim/${anim}/`;
...
export default function IPhone18ProPage() {
  return (
    <main className="bg-black text-white">
      <ProductSubnav title="iPhone 18 Pro" items={NAV_ITEMS} dark />

      {/* ── Section 1: Media hero ─────────────────────────── */}
      <section className="relative bg-black">
        <div className="relative z-10 pt-[70px] text-center">
          <p className="text-[21px] font-semibold text-[#2997ff]">iPhone 18 Pro</p>
          ...
          <div className="mt-6">
            <Link
              href="/us/shop/goto/buy_iphone/iphone_18_pro"
        ...
        <div className="mx-auto max-w-none">
          <InlineMedia
            startStem={P("media-hero/hero_startframe__ck15fj8f67hy")}
            endStem={P("media-hero/hero_endframe__fbxsnz8txcia")}
            videoBase={V("hero")}
      ...
      <section id="highlights" className="bg-black py-6">
        ...
        <div className="mx-auto grid max-w-[1024px] gap-4 px-4 pb-16 pt-4 md:grid-cols-4">
          {[
            ...
            ["Battery", "The longest battery life in an iPhone.1 Up to 45 hours video playback on iPhone 18 Pro Max.2"],
      ...
      <section className="bg-black">
        <Head
          ...
          title="Most wanted."
          sub="iPhone 18 Pro is purpose-built for unprecedented performance.4 Get up to 6 more hours of video playback on iPhone 18 Pro Max, faster wired charging, a vapor-cooled A20 Pro chip for the most intensive AI workloads, and a new 48MP Fusion Main camera with variable aperture. All in a durable unibody with Ceramic Shield front and back — everything a pro wants."
        />
        <div className="mx-auto max-w-[1024px] px-4 pb-16">
          <ApplePicture stem={P("aio/hero__elo7tt0mnqy6")} className="block w-full rounded-2xl" imgClassName="w-full" />
        </div>
      </section>
      ...
      <section id="design" className="bg-[#0a0a0c] pb-4">
        ...
        <div className="mx-auto grid max-w-[1024px] gap-4 px-4 pb-16 pt-6 md:grid-cols-3">
          {[
            ["Two sizes", "6.9-inch iPhone 18 Pro Max and 6.3-inch iPhone 18 Pro, featuring brilliant Super Retina XDR displays with ProMotion up to 120Hz."],
      ...
      <section id="cameras" className="bg-black">
        <Head
          ...
          sub="Meet our best-ever camera system for pros and creators. iPhone 18 Pro breaks new ground with a variable aperture on the 48MP Fusion Main camera, delivering better low-light photos and video and sharper detail throughout the scene. And with new Pro controls and Photographic Styles to adjust texture and grain, you’ll have even more creative range."
        />
        <div className="mx-auto grid max-w-[1024px] gap-4 px-4 pb-8 md:grid-cols-3">
          {[
            ...
            ["48MP Fusion Ultra Wide", "13 mm focal length (.5x/macro), ƒ/2.2 aperture."],
          ].map(([t, d]) => (
            <div key={t} className="rounded-2xl bg-[#161617] p-5">
      ...
      <section id="pro-video" className="bg-black py-4">
        <Head
          ...
          sub="iPhone 18 Pro lets you add Cinematic mode effects to regular video — even after you shoot — so any moment can feel like a movie. Support for 60 fps makes slo-mo smooth. And with Audio Mix, you can isolate a musical performance from its surroundings, so every note comes through clearly."
        />
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center rounded-2xl bg-[#161617] p-6">
              ...
              <p className="mt-2 text-[15px] text-white/70">
                The iPhone 18 Pro camera system improves low-light video at night or indoors by intelligently adjusting
      ...
      <section id="battery" className="bg-black py-4">
        <Head
          ...
          sub="Up to 30 hours of use per charge on iPhone 18 Pro Max.6"
        />
        <div className="mx-auto max-w-[980px] px-4 pb-16">
          <ApplePicture stem={P("battery/hero__elo7tt0mnqy6")} className="block w-full rounded-2xl" imgClassName="w-full" />
          <p className="mx-auto mt-6 max-w-[640px] text-center text-[15px] leading-relaxed text-white/70">
            iPhone 18 Pro Max delivers a massive leap in battery life with up to 45 hours of video playback — 6 more
            hours than iPhone 17 Pro Max. Thanks to faster wired charging, iPhone 18 Pro reaches up to 50 percent
      ...
      <section className="bg-[#f5f5f7] pb-4 pt-20 text-black">
        <div className="mx-auto max-w-[1024px] px-4 text-center">
          ...
          <div className="mt-8">
            <Link href="/us/shop/goto/buy_iphone/iphone_18_pro" className="link-blue text-[17px]">
      ...
      <section className="bg-[#f5f5f7] pb-4 pt-10 text-black">
        <div className="mx-auto max-w-[1024px] px-4">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {[
              { t: "iPhone 18 Pro", s: "The ultimate battery life, performance, and camera of any iPhone.", i: P("aio/hero__elo7tt0mnqy6"), ext: "jpg" as const, h: "/iphone-18-pro" },
              { t: "iPhone Duo", s: "A masterpiece over an amazing all-new design.", i: A("/v/iphone-18-pro/a/images/site/localnav/iphone_duo__es1je56gg18i"), ext: "png" as const, h: "/iphone-duo" },
              { t: "Compare", s: "Find your perfect iPhone.", i: A("/v/iphone-18-pro/a/images/site/localnav/compare__clhjrq5m2ymq"), ext: "png" as const, h: "/iphone/compare" },
            ].map((c) => (
      ...
      <section className="bg-[#f5f5f7] pb-16 pt-8 text-black">
        <div className="mx-auto max-w-[980px] px-4">
          <p className="text-[13px] leading-relaxed text-[#6e6e73]">
            ...
            English. 4 Compared with iPhone 17 Pro Max. 5 Compared with iPhone 17 Pro. 6 6.9-inch iPhone 18 Pro Max and
            6.3-inch iPhone 18 Pro display diagonals. 7 Testing conducted by Apple in July 2026. Battery life varies by
